...
1. אין credential ניהולי מקומי או Supabase dashboard session לביצוע/אימות DDL, Storage ו־profiles.
2. אין הוכחה חיה ש־migration 002 ו־003 הורצו.
3. אין proof של immutable reviews על DB חי.
4. ~~אין הרשאת GitHub API/CLI לאימות שמות GitHub Actions secrets.~~ **נסגר** — ראו §7: שני ה־secrets אומתו דרך התוצר החי.
5. כלי הייבוא עדיין אינו locale-aware; אין להעלות את האנגלית באמצעותו לפני תיקון סעיף 5.
6. חבילת אנגלית כוללת 18 documents בלבד; ארבעה concepts חסרים במסמכי מקור מאושרים באנגלית.
